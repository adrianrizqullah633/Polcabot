...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6 header-container">
        ...
        <div class="flex items-center gap-4 search-actions">
            <form action="{{ route('admin.jurusan.index') }}" method="GET" class="relative">
                <input 
                    type="text" 
                    name="search"
    ...
    <div class="bg-white rounded-lg overflow-hidden shadow-sm">
        ...
        <div class="hidden md:grid grid-cols-12 gap-4 px-4 py-4 border-2 border-blue-300 rounded-lg mb-2 mx-2 mt-2 items-center">
            ...
            <div class="col-span-1 flex gap-2 justify-center">
                <a href="{{ route('admin.jurusan.edit', $data->id) }}" class="text-yellow-500 hover:text-yellow-600">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                    </svg>
                </a>
                <form action="{{ route('admin.jurusan.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                    @csrf
                    @method('DELETE')
        ...
        <div class="md:hidden border-2 border-blue-300 rounded-lg mb-3 mx-2 mt-2 table-row-mobile">
            ...
            <div class="mobile-card-item">
                ...
                <span class="mobile-value">{{ Str::limit($data->question, 50) }}</span>
            </div>
            <div class="mobile-card-item">
                <span class="mobile-label">Answer:</span>
                <span class="mobile-value">{{ Str::limit($data->answer, 50) }}</span>
            </div>
            <div class="mobile-card-item">
