...
class BeasiswaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Query ke database
        $query = DB::table('beasiswa_knowledge');
        ...
        // Kirim data ke view
        return view('admin.beasiswa.index', compact('datasets'));
    }
    ...
    public function edit($id)
    {
        ...
        $dataset = DB::table('beasiswa_knowledge')->where('id', $id)->first();
        ...
        // Kirim data ke view
        return view('admin.beasiswa.edit', compact('dataset'));
    }
    ...
    public function destroy($id)
    {
        ...
        DB::table('beasiswa_knowledge')->where('id', $id)->delete();
