...
class DaftarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Query ke database
        $query = DB::table('daftar_knowledge');
        ...
        // Kirim data ke view
        return view('admin.daftar.index', compact('datasets'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.daftar.index')
    ...
    public function edit($id)
    {
        ...
        $dataset = DB::table('daftar_knowledge')->where('id', $id)->first();
        ...
        // Kirim data ke view
        return view('admin.daftar.edit', compact('dataset'));
    }
    ...
    public function destroy($id)
    {
        ...
        DB::table('daftar_knowledge')->where('id', $id)->delete();
