    ...
    <div class="bg-white rounded-lg overflow-hidden">
        ...
        <div class="hidden md:grid grid-cols-12 gap-4 px-4 py-4 border-2 border-blue-300 rounded-lg mb-2 mx-2 mt-2 items-center">
            ...
            <div class="col-span-1 flex gap-2 justify-end">
                <a href="<?php echo e(route('admin.daftar.edit', $data->id)); ?>" class="text-yellow-500 hover:text-yellow-600">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                    </svg>
                </a>
                <form action="<?php echo e(route('admin.daftar.destroy', $data->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                    <?php echo csrf_field(); ?>
        ...
        <div class="md:hidden border-2 border-blue-300 rounded-lg mb-3 mx-2 mt-2 table-row-mobile">
            ...
            <div class="mobile-card-item">
                ...
                <span class="mobile-value"><?php echo e(Str::limit($data->question, 60)); ?></span>
            </div>
            <div class="mobile-card-item">
                <span class="mobile-label">Answer:</span>
                <span class="mobile-value"><?php echo e(Str::limit($data->answer, 60)); ?></span>
            </div>
            <div class="mobile-card-item">
                ...
                <a href="<?php echo e($data->source); ?>" target="_blank" class="mobile-value text-blue-600 hover:underline break-all">
                    <?php echo e(Str::limit($data->source, 35)); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Polcabot-9\resources\views/admin/daftar/index.blade.php ENDPATH**/ ?>